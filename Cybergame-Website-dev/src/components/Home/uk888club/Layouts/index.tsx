...
const PageHomeLayout: FC<IProps> = ({ title, children, label, back }) => {
  ...
  const schema = {
    ...
    '@type': 'Organization',
    name: 'uk888club',
    url: 'https://uk888club.com/',
    logo: 'https://uk888club.com/images/uk888club/logo.png',
    description:
  ...
  return (
    <Fragment>
      <NextHead>
        ...
        <meta name="author" content="uk888club" />
        <link rel="canonical" href="https://uk888club.com/" />
