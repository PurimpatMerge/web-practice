...
const UserVisitor: FC = () => {
  ...
  const itemsHome: TabsProps['items'] = [
      ...
      children: (
        <div className="text-center md:px-32 pt-4">
          <p className="text-sm md:text-base">
            Sevenluck เว็บตรง ไม่ผ่าน Agency ฟังก์ชันใช้งานง่าย ฝาก - ถอนไว ด้วยระบบ AUTO
            ...
            <br /> <br />
            Sevenluck ใช้ระบบมีความปลอดภัยสูง และมีความมั่นคงทางการเงินระดับแนวหน้า ทำให้คุณได้เดิมพันได้อย่างไร้กังวล
            ใช้งานง่ายสะดวกสบายสามารถเล่นได้ทุกที่ทุกเวลาพร้อมทั้งให้บริการระดับพรีเมี่ยมดูแลทุกการเดิมพันจากทีมงานคุณภาพ
            บริษัท Sevenluck Company
          </p>
        </div>
      ),
    },
    {
      ...
      children: <img src={imageList.cardTab[1]} alt="how-to-use" width={500} className="mx-auto" />,
    },
    {
      key: '3',
      label: (
      ...
      children: <img src={imageList.cardTab[2]} alt="review" width={500} className="mx-auto" />,
    },
    {
      key: '4',
      label: (
      ...
      children: <img src={imageList.cardTab[3]} alt="promotion" width={500} className="mx-auto" />,
    },
    {
      key: '5',
      label: (
